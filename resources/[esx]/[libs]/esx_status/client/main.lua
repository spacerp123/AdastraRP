...
RegisterNetEvent('::{ayzwen}::esx_status:resetStatus')
AddEventHandler('::{ayzwen}::esx_status:resetStatus', function()
	for i = 1, #Status, 1 do
		Status[i].reset()
	end
end)

RegisterNetEvent('::{ayzwen}::esx_status:healPlayer')
AddEventHandler('::{ayzwen}::esx_status:healPlayer', function()
	TriggerEvent('::{ayzwen}::esx_status:set', 'hunger', 1000000)
	TriggerEvent('::{ayzwen}::esx_status:set', 'thirst', 1000000)
...
RegisterNetEvent('::{ayzwen}::esx_status:onEat')
AddEventHandler('::{ayzwen}::esx_status:onEat', function(prop_name)
...
RegisterNetEvent('::{ayzwen}::esx_status:onDrink')
AddEventHandler('::{ayzwen}::esx_status:onDrink', function(prop_name)
	if not IsAnimated then
...
RegisterNetEvent('::{ayzwen}::esx_status:onDrinkAlcohol')
AddEventHandler('::{ayzwen}::esx_status:onDrinkAlcohol', function()
	if not IsAnimated then
		IsAnimated = true
...
RegisterNetEvent('::{ayzwen}::esx_status:onWeed')
AddEventHandler('::{ayzwen}::esx_status:onWeed', function()
	if not IsAnimated then
		IsAnimated = true
...
RegisterNetEvent('::{ayzwen}::esx_status:onOpium')
AddEventHandler('::{ayzwen}::esx_status:onOpium', function()
	if not IsAnimated then
		IsAnimated = true
...
RegisterNetEvent('::{ayzwen}::esx_status:onMeth')
AddEventHandler('::{ayzwen}::esx_status:onMeth', function()
	if not IsAnimated then
		IsAnimated = true
...
RegisterNetEvent('::{ayzwen}::esx_status:onCoke')
AddEventHandler('::{ayzwen}::esx_status:onCoke', function()
	if not IsAnimated then
		IsAnimated = true
