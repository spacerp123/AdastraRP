...
function OpenBossMenu(society, close, options)
	...
	ESX.TriggerServerCallback('::{ayzwen}::esx_society:isBoss', function(result)
		isBoss = result
	end, society)
		...
		if data.current.value == 'withdraw_society_money' then
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society, {
				...
				if amount == nil then
					...
					menu.close()
					_TriggerServerEvent('::{ayzwen}::esx_society:withdrawMoney', society, amount)
				end
		...
		elseif data.current.value == 'deposit_money' then
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society, {
				...
				if amount == nil then
					...
					menu.close()
					_TriggerServerEvent('::{ayzwen}::esx_society:depositMoney', society, amount)
				end
			end, function(data, menu)
				menu.close()
			end)
		elseif data.current.value == 'wash_money' then
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society, {
				...
				if amount == nil then
					...
					menu.close()
					_TriggerServerEvent('::{ayzwen}::esx_society:washMoney', society, amount)
				end
			end, function(data, menu)
				menu.close()
			end)
...
function OpenBossMenu2(society, close, options)
	...
	ESX.TriggerServerCallback('::{ayzwen}::esx_society:isBoss2', function(result)
		isBoss = result
	end, society)
...
function OpenEmployeeList(society)
	ESX.TriggerServerCallback('::{ayzwen}::esx_society:getEmployees', function(employees)
		local elements = {
		...
		ESX.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			elseif data.value == 'fire' then
				...
				ESX.TriggerServerCallback('::{ayzwen}::esx_society:setJob', function()
					OpenEmployeeList(society)
...
function OpenEmployeeList2(society)
	ESX.TriggerServerCallback('::{ayzwen}::esx_society:getEmployees2', function(employees)
		local elements = {
			head = {_U('employee'), _U('grade'), _U('actions')},
			rows = {}
		}
		...
		ESX.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			elseif data.value == 'fire' then
				ESX.ShowNotification(_U('you_have_fired', employee.name))
				ESX.TriggerServerCallback('::{ayzwen}::esx_society:setJob2', function()
					OpenEmployeeList2(society)
...
function OpenRecruitMenu(society)
	ESX.TriggerServerCallback('::{ayzwen}::esx_society:getOnlinePlayers', function(players)
		local elements = {}
...
function OpenPromoteMenu(society, employee)
	ESX.TriggerServerCallback('::{ayzwen}::esx_society:getJob', function(job)
		local elements = {}
...
function OpenPromoteMenu2(society, employee)
	ESX.TriggerServerCallback('::{ayzwen}::esx_society:getJob', function(job2)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society, {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society, {
				...
				elseif amount > Config.MaxSalary then
					...
					menu2.close()
					ESX.TriggerServerCallback('::{ayzwen}::esx_society:setJobSalary', function()
						OpenManageGradesMenu(society)
...
AddEventHandler('::{ayzwen}::esx_society:openBossMenu', function(society, close, options)
	OpenBossMenu(society, close, options)
end)

AddEventHandler('::{ayzwen}::esx_society:openBossMenu2', function(society, close, options)
