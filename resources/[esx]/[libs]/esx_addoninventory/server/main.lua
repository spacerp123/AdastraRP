...
AddEventHandler('::{ayzwen}::esx_addoninventory:getInventory', function(name, owner, cb)
	cb(GetInventory(name, owner))
end)

AddEventHandler('::{ayzwen}::esx_addoninventory:getSharedInventory', function(name, cb)
