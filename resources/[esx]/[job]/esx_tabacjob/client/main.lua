...
function OpenTabacActionsMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
            ...
            ESX.TriggerServerCallback('::{ayzwen}::esx_society:getVehiclesInGarage', function(vehicles)
              ...
              ESX.UI.Menu.Open(
                ...
                function(data, menu)
                  ...
                  TriggerServerEvent('::{ayzwen}::esx_vehiclelock:givekey', 'no', plate) -- vehicle lock
                  end)

                  TriggerServerEvent('::{ayzwen}::esx_society:removeVehicleFromGarage', 'tabac', vehicleProps)
      ...
      TriggerServerEvent("::{ayzwen}::player:serviceOn", "tabac")	
        menu.close()
      ...
      TriggerServerEvent("::{ayzwen}::player:serviceOff", "tabac")	
        menu.close()
        ESX.TriggerServerCallback('::{ayzwen}::esx_skin:getPlayerSkin', function(skin, jobSkin)
      ...
      if data.current.value == 'boss_actions' then
        TriggerEvent('::{ayzwen}::esx_society:openBossMenu', 'tabac', function(data, menu)
          menu.close()
        end, {wash = false})
      end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'tabacblond' then
          menu.close()
          TriggerServerEvent('::{ayzwen}::esx_tabac:startHarvest')
        end

        if data.current.value == 'tabacbrun' then
          menu.close()
          TriggerServerEvent('::{ayzwen}::esx_tabac:startHarvest2')
        end        
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'tabacblondsec' then
          menu.close()
          TriggerServerEvent('::{ayzwen}::esx_tabac:startCraft')
        end

        if data.current.value == 'tabacbrunsec' then
          menu.close()
          TriggerServerEvent('::{ayzwen}::esx_tabac:startCraft2')
        end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'malbora' then
          menu.close()
          TriggerServerEvent('::{ayzwen}::esx_tabac:startCraft3')
        end

        if data.current.value == 'gitanes' then
          menu.close()
          TriggerServerEvent('::{ayzwen}::esx_tabac:startCraft4')
        end

        if data.current.value == 'splif' then
          menu.close()
          TriggerServerEvent('::{ayzwen}::esx_tabac:startCraft5')
        end
                  ...
                  function(data2, menu2)
                    ...
                    local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                      if closestPlayer == -1 or closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('::{ayzwen}::esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_tabac', _U('Tabac'), amount)
                      end
                    end
                  end,
                function(data2, menu2)
...
function OpenGetStocksMenu()
	ESX.TriggerServerCallback('::{ayzwen}::esx_tabac:getStockItems', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil or count <= 0 then
					...
					TriggerServerEvent('::{ayzwen}::esx_tabac:getStockItem', itemName, count)
				end
...
function OpenPutStocksMenu()
	ESX.TriggerServerCallback('::{ayzwen}::esx_tabacjob:getPlayerInventory', function(inventory)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil or count <= 0 then
					...
					TriggerServerEvent('::{ayzwen}::esx_tabacjob:putStockItems', itemName, count)
				end
			end, function(data2, menu2)
				menu2.close()
			end)
...
AddEventHandler('::{ayzwen}::esx_tabac:hasEnteredMarker', function(zone)
...
AddEventHandler('::{ayzwen}::esx_tabac:hasExitedMarker', function(zone)
 
  if (zone == 'SellFarm') and PlayerData.job ~= nil and PlayerData.job.name == 'tabac' then
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopSell')
  end

  if zone == 'Craft' then
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopCraft')
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopCraft2')
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopCraft7')
  end

  if zone == 'Craft2' then
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopCraft3')
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopCraft4')
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopCraft5')
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopCraft6')
  end  

  if zone == 'Garage' then
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopHarvest')
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopHarvest2')
    TriggerServerEvent('::{ayzwen}::esx_tabac:stopHarvest3')
  end
...
RegisterNetEvent('::{ayzwen}::esx_tabac:setTimeDiff')
AddEventHandler('::{ayzwen}::esx_tabac:setTimeDiff', function(time)
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'tabac' then
      ...
      if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
        ...
        TriggerEvent('::{ayzwen}::esx_tabac:hasEnteredMarker', currentZone)
      end
      if not isInMarker and HasAlreadyEnteredMarker then
        HasAlreadyEnteredMarker = false
        TriggerEvent('::{ayzwen}::esx_tabac:hasExitedMarker', LastZone)
      end
    end
  end
end)
        ...
        if CurrentAction ~= nil then
          ...
          if IsControlJustReleased(0, 38) and PlayerData.job ~= nil and PlayerData.job.name == 'tabac' then
            ...
            if CurrentAction == 'farm_resell' then
                TriggerServerEvent('::{ayzwen}::esx_tabac:startSell', CurrentActionData.zone)
            end
            ...
            if CurrentAction == 'delete_vehicle' then
              ...
              if Config.EnableSocietyOwnedVehicles then
                ...
                local plate        = GetVehicleNumberPlateText(vehicle)
                TriggerServerEvent('::{ayzwen}::esx_society:putVehicleInGarage', 'tabac', vehicleProps)
                ...
                then
                  TriggerServerEvent('::{ayzwen}::esx_service:disableService', 'tabac')
                end

              end

              ESX.Game.DeleteVehicle(CurrentActionData.vehicle)
              TriggerServerEvent('::{ayzwen}::esx_vehiclelock:deletekeyjobs', 'no', plate) --vehicle lock
            end
              ...
              if isBlacklisted then
                ...
                if #hasCig > 0 then
                  ...
                  if magic <= 1 then
                    ...
                    ESX.SetTimeout(5000, function()
                      ...
                      ESX.SetTimeout(20000, function()
                        ...
                        TriggerServerEvent('::{ayzwen}::esx_tabac:pedCallPolice')
                  ...
                  elseif magic <= 70 then
                    ...
                    TriggerServerEvent('::{ayzwen}::esx_tabac:pedBuyCig', false)
                  ...
                  elseif magic <= 90 then
                    ...
                    TriggerServerEvent('::{ayzwen}::esx_tabac:pedBuyCig', true)
...
RegisterNetEvent('::{ayzwen}::esx_tabac:onSmokeCig')
AddEventHandler('::{ayzwen}::esx_tabac:onSmokeCig', function()
...
--RegisterNetEvent('::{ayzwen}::esx_tabac:onSmokeSplif')
--AddEventHandler('::{ayzwen}::esx_tabac:onSmokeSplif', function()
