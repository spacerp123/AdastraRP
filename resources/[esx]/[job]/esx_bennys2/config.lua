...
Config.Zones = {
	...
	ls2 = {
		Pos = {x = -240.2, y = -1318.97, z = 30.89},
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		Name = "HardCores Bennys",
		Hint = _U('press_custom')
	},
	ls3 = {
		Pos = {x = -233.88, y = -1318.8, z = 30.89},
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		Name = "HardCoress Bennys",
		Hint = _U('press_custom')
	},
	ls4 = {
		Pos = {x = -241.24, y = -1334.65, z = 30.89},
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		Name = "HardCoresss Bennys",
		Hint = _U('press_custom')
	},
	ls5 = {
		Pos = {x = -232.07, y = -1336.25, z = 30.89},
		Size = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		Name = "HardCoressss Bennys",
		Hint = _U('press_custom')
	}
}
