Locales['fr'] = {
	...
	['vehicle_spawner'] = 'appuyez sur ~INPUT_CONTEXT~ pour faire appeler un véhicule de service',
	['store_vehicle'] = 'appuyez sur ~INPUT_CONTEXT~ pour ranger votre véhicule de service',
	['helicopter_spawner'] = 'appuyez sur ~INPUT_CONTEXT~ pour sortir un hélicoptère de service',
	-- Service
	...
	['being_searched'] = 'vous vous faites ~y~fouillé~s~ par l ~b~FBI~s~',
	-- Vehicle interaction
