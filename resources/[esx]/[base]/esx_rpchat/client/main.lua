...
RegisterNetEvent('::{ayzwen}::3dme:trigger')
AddEventHandler('::{ayzwen}::3dme:trigger', function(targetId, message)
...
RegisterNetEvent('::{ayzwen}::adminTag:trigger')
AddEventHandler('::{ayzwen}::adminTag:trigger', function(sender, message)
