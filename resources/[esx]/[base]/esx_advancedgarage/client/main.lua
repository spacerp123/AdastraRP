...
AddEventHandler('::{ayzwen}::esx:playerLoaded', function(xPlayer)
	if Config.UsePrivateCarGarages then
		ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:getOwnedProperties', function(properties)
...
function ListOwnedCarsMenu()
	...
	ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:getOwnedCars', function(ownedCars)
...
function ListOwnedBoatsMenu()
	...
	ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:getOwnedBoats', function(ownedBoats)
...
function ListOwnedAircraftsMenu()
	...
	ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:getOwnedAircrafts', function(ownedAircrafts)
...
function StoreOwnedCarsMenu()
	...
	if IsPedInAnyVehicle(playerPed, false) then
		...
		ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:storeVehicle', function(valid)
			if valid then
...
function ReturnOwnedCarsMenu()
	ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:getOutOwnedCars', function(ownedCars)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_car', {
			...
			ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:checkMoneyCars', function(hasEnoughMoney)
				if hasEnoughMoney then
					_TriggerServerEvent('::{ayzwen}::esx_advancedgarage:payCar')
...
function ReturnOwnedBoatsMenu()
	ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:getOutOwnedBoats', function(ownedBoats)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_boat', {
			...
			ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:checkMoneyBoats', function(hasEnoughMoney)
				if hasEnoughMoney then
					_TriggerServerEvent('::{ayzwen}::esx_advancedgarage:payBoat')
					SpawnPoundedVehicle(data.current.value, data.current.value.plate)
				else
					ESX.ShowNotification(_U('not_enough_money'))
				end
...
function ReturnOwnedAircraftsMenu()
	ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:getOutOwnedAircrafts', function(ownedAircrafts)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_aircraft', {
			...
			ESX.TriggerServerCallback('::{ayzwen}::esx_advancedgarage:checkMoneyAircrafts', function(hasEnoughMoney)
				if hasEnoughMoney then
					_TriggerServerEvent('::{ayzwen}::esx_advancedgarage:payAircraft')
					SpawnPoundedVehicle(data.current.value, data.current.value.plate)
				else
					ESX.ShowNotification(_U('not_enough_money'))
				end
...
function reparation(apprasial, vehicle, vehicleProps)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'delete_menu', {
		...
		if data.current.value == 'yes' then
			_TriggerServerEvent('::{ayzwen}::esx_advancedgarage:payhealth', apprasial)
			putaway(vehicle, vehicleProps)
...
function putaway(vehicle, vehicleProps)
	...
	_TriggerServerEvent('::{ayzwen}::esx_advancedgarage:setVehicleState', vehicleProps.plate, true)
...
function SpawnVehicle(vehicle, plate)
	...
	_TriggerServerEvent('::{ayzwen}::esx_advancedgarage:setVehicleState', plate, false)
end
...
AddEventHandler('::{ayzwen}::esx_advancedgarage:hasEnteredMarker', function(zone)
...
AddEventHandler('::{ayzwen}::esx_advancedgarage:hasExitedMarker', function()
	ESX.UI.Menu.CloseAll()
	CurrentAction = nil
end)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if isInMarker and not hasAlreadyEnteredMarker then
			...
			TriggerEvent('::{ayzwen}::esx_advancedgarage:hasEnteredMarker', currentZone)
		end
		
		if not isInMarker and hasAlreadyEnteredMarker then
			hasAlreadyEnteredMarker = false
			TriggerEvent('::{ayzwen}::esx_advancedgarage:hasExitedMarker', LastZone)
		end
