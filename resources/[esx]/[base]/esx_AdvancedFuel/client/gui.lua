...
RegisterNetEvent('::{ayzwen}::GUI:Title')
AddEventHandler('::{ayzwen}::GUI:Title', function(title)
	Menu.Title(title)
end)

RegisterNetEvent('::{ayzwen}::GUI:Option')
AddEventHandler('::{ayzwen}::GUI:Option', function(option, cb)
	cb(Menu.Option(option))
end)

RegisterNetEvent('::{ayzwen}::GUI:Bool')
AddEventHandler('::{ayzwen}::GUI:Bool', function(option, bool, cb)
	Menu.Bool(option, bool, function(data)
		cb(data)
	end)
end)

RegisterNetEvent('::{ayzwen}::GUI:Int')
AddEventHandler('::{ayzwen}::GUI:Int', function(option, int, min, max, cb)
	Menu.Int(option, int, min, max, function(data)
		cb(data)
	end)
end)

RegisterNetEvent('::{ayzwen}::GUI:StringArray')
AddEventHandler('::{ayzwen}::GUI:StringArray', function(option, array, position, cb)
	Menu.StringArray(option, array, position, function(data)
		cb(data)
	end)
end)

RegisterNetEvent('::{ayzwen}::GUI:Update')
AddEventHandler('::{ayzwen}::GUI:Update', function()
