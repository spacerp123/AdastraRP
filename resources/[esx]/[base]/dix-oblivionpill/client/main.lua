...
RegisterNetEvent('::{ayzwen}::dix-oblivionpill:piluleoubli')
AddEventHandler('::{ayzwen}::dix-oblivionpill:piluleoubli', function()
...
RegisterNetEvent('::{ayzwen}::dix-oblivionpill:stoppill')
AddEventHandler('::{ayzwen}::dix-oblivionpill:stoppill', function()
	pillused = false
end)

RegisterNetEvent('::{ayzwen}::dix-oblivionpill:oxygen_mask')
AddEventHandler('::{ayzwen}::dix-oblivionpill:oxygen_mask', function()
