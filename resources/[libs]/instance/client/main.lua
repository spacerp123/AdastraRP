...
function CreateInstance(type, data)
	_TriggerServerEvent(':{ayzwen}::instance:create', type, data)
end

function CloseInstance()
	instance = {}
	_TriggerServerEvent(':{ayzwen}::instance:close')
	insideInstance = false
end

function EnterInstance(instance)
	insideInstance = true
	_TriggerServerEvent(':{ayzwen}::instance:enter', instance.host)
...
function LeaveInstance()
	if instance.host then
		...
		_TriggerServerEvent(':{ayzwen}::instance:leave', instance.host)
	end
...
function InviteToInstance(type, player, data)
	_TriggerServerEvent(':{ayzwen}::instance:invite', instance.host, type, player, data)
end
...
AddEventHandler(':{ayzwen}::instance:get', function(cb)
	cb(instance)
end)
...
AddEventHandler(':{ayzwen}::instance:enter', function(_instance)
	EnterInstance(_instance)
end)

AddEventHandler(':{ayzwen}::instance:leave', function()
	LeaveInstance()
end)

AddEventHandler(':{ayzwen}::instance:invite', function(type, player, data)
	InviteToInstance(type, player, data)
end)

AddEventHandler(':{ayzwen}::instance:registerType', function(name, enter, exit)
	RegisterInstanceType(name, enter, exit)
end)

RegisterNetEvent(':{ayzwen}::instance:onInstancedPlayersData')
AddEventHandler(':{ayzwen}::instance:onInstancedPlayersData', function(_instancedPlayers)
	instancedPlayers = _instancedPlayers
end)

RegisterNetEvent(':{ayzwen}::instance:onCreate')
AddEventHandler(':{ayzwen}::instance:onCreate', function(_instance)
	instance = {}
end)

RegisterNetEvent(':{ayzwen}::instance:onEnter')
AddEventHandler(':{ayzwen}::instance:onEnter', function(_instance)
	instance = _instance
end)

RegisterNetEvent(':{ayzwen}::instance:onLeave')
AddEventHandler(':{ayzwen}::instance:onLeave', function(_instance)
	instance = {}
end)

RegisterNetEvent(':{ayzwen}::instance:onClose')
AddEventHandler(':{ayzwen}::instance:onClose', function(_instance)
	instance = {}
end)

RegisterNetEvent(':{ayzwen}::instance:onPlayerEntered')
AddEventHandler(':{ayzwen}::instance:onPlayerEntered', function(_instance, player)
	instance = _instance
...
AddEventHandler(':{ayzwen}::instance:onPlayerLeft', function(_instance, player)
	instance = _instance
	ESX.ShowNotification(_('left_out', GetPlayerName(GetPlayerFromServerId(player))))
end)

RegisterNetEvent(':{ayzwen}::instance:onInvite')
AddEventHandler(':{ayzwen}::instance:onInvite', function(_instance, type, data)
	instanceInvite = {
		type = type,
		host = _instance,
		data = data
...
Citizen.CreateThread(function()
	TriggerEvent(':{ayzwen}::instance:loaded')
end)
