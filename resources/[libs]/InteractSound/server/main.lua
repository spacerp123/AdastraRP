...
------
RegisterServerEvent(':{ayzwen}::InteractSound_SV:PlayOnOne')
AddEventHandler(':{ayzwen}::InteractSound_SV:PlayOnOne', function(clientNetId, soundFile, soundVolume)
	TriggerClientEvent(':{ayzwen}::InteractSound_CL:PlayOnOne', clientNetId, soundFile, soundVolume)
end)
...
------
RegisterServerEvent(':{ayzwen}::InteractSound_SV:PlayOnSource')
AddEventHandler(':{ayzwen}::InteractSound_SV:PlayOnSource', function(soundFile, soundVolume)
	TriggerClientEvent(':{ayzwen}::InteractSound_CL:PlayOnOne', source, soundFile, soundVolume)
end)
...
------
RegisterServerEvent(':{ayzwen}::InteractSound_SV:PlayOnAll')
AddEventHandler(':{ayzwen}::InteractSound_SV:PlayOnAll', function(soundFile, soundVolume)
	local _source = source
	TriggerEvent("ratelimit", source, ":{ayzwen}::InteractSound_SV:PlayOnAll")
	print('User played a sound : Sound : ' .. soundFile .. ' | ' .. GetPlayerName(_source) .. ' [' .. _source .. '] - ' .. ESX.GetIdentifierFromId(_source))
	TriggerClientEvent(':{ayzwen}::InteractSound_CL:PlayOnAll', -1, soundFile, soundVolume)
end)
...
------
RegisterServerEvent(':{ayzwen}::InteractSound_SV:PlayWithinDistance')
AddEventHandler(':{ayzwen}::InteractSound_SV:PlayWithinDistance', function(maxDistance, soundFile, soundVolume)
	local _source = source
	TriggerEvent("ratelimit", source, ":{ayzwen}::InteractSound_SV:PlayWithinDistance")
	print('User played a sound : Sound : ' .. soundFile .. ' | ' .. maxDistance .. ' | ' .. GetPlayerName(_source) .. ' [' .. _source .. '] - ' .. ESX.GetIdentifierFromId(_source))
	TriggerClientEvent(':{ayzwen}::InteractSound_CL:PlayWithinDistance', -1, source, maxDistance, soundFile, soundVolume)
end)