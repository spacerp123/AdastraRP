...
------
RegisterNetEvent(':{ayzwen}::InteractSound_CL:PlayOnOne')
AddEventHandler(':{ayzwen}::InteractSound_CL:PlayOnOne', function(soundFile, soundVolume)
	SendNUIMessage({
...
------
RegisterNetEvent(':{ayzwen}::InteractSound_CL:PlayOnAll')
AddEventHandler(':{ayzwen}::InteractSound_CL:PlayOnAll', function(soundFile, soundVolume)
	SendNUIMessage({
		transactionType = 'playSound',
		transactionFile = soundFile,
		transactionVolume = soundVolume
...
------
RegisterNetEvent(':{ayzwen}::InteractSound_CL:PlayWithinDistance')
AddEventHandler(':{ayzwen}::InteractSound_CL:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
