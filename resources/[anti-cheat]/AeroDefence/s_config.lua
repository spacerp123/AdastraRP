...
PS.MessagesBan = {
    TooFastVehicle = "You have been caught using Ram Modification, discord.gg/adastrarp",
    SuperJump = "You have been caught using Super Jump, discord.gg/adastrarp",
    LimitPeds = "You have been caught Spamming Peds, discord.gg/adastrarp",
    LimitVehicles = "You have been caught Spamming Vehicles, discord.gg/adastrarp",
    LimitObjects = "You have been caught Spamming Props, discord.gg/adastrarp",
    LimitParticles = "You have been caught Spamming Particles, discord.gg/adastrarp",
    LimitKills = "You have been caught Spamkilling, discord.gg/adastrarp",
    AntiSpamEvents = "You have been caught Spamming a specific event, discord.gg/adastrarp",
    LimitExplosions = "You have been caught Spamming Explosions, discord.gg/adastrarp",
    BlacklistExplosions = "You have been caught using a Blacklisted Explosion, discord.gg/adastrarp",
    AntiInvisExplosions = "You have been caught using an Invisible Explosion, discord.gg/adastrarp",
    AntiSilentExplosions = "You have been caught using a Silent Explosion, discord.gg/adastrarp",
    AntiBlacklistedMessages = "You have been caught posting a Blacklisted Message, discord.gg/adastrarp",
    AntiBlacklistedTriggers = "You have been caught using a Blacklisted Trigger, discord.gg/adastrarp",
    AntiFakeMessages = "You have been caught posting with a Fake Name, discord.gg/adastrarp",
    AntiBlacklistedMessengers = "You have been caught posting with a Blacklisted Name, discord.gg/adastrarp",
    BlacklistVehicles = "You have been caught using a Blacklisted Vehicle, discord.gg/adastrarp,",
    BlacklistProps = "You have been caught spawning a Blacklisted Prop, discord.gg/adastrarp,",
    BlacklistPeds = "You have been caught spawning a Blacklisted Ped, discord.gg/adastrarp,",
    CannotGiveWeapon = "You have been caught giving a weapon, discord.gg/adastrarp",
    AntiRemoveWeapon = "You have been caught removing a weapon, discord.gg/adastrarp",
    AntiSoloSession = "You have been caught being in a solo session, discord.gg/adastrarp",
    CannotCancelOtherEvent = "You have been caught cancelling other player's weapon, discord.gg/adastrarp",
    CheckHasWeaponESX = "You have been caught shooting a weapon that you did not have, discord.gg/adastrarp",
    OtherJail = "You have been caught trying to manipulate the jail system, discord.gg/adastrarp",
...
PS.AppealMessage = "https/discord.gg/adastrarp" --> Text under name, recommend discord URL or website for appeal.
