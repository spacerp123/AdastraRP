...
WsT.AllowedCountrys = {"GB","US","BE","FR","DE","CA","CH"} -- https://www.iban.com/country-codes - Use ALPHA-2 codes

WsT.BlacklistedNames = {"anticheat"} -- IF PLAYER NAME CONTAINS ONE OF THESE WORDS HE IS KICKED
WsT.BlacklistedCommands = { 'pk', 'haha', 'lol', 'xddd', 'chocolate', 'panickey', 'jolmany', 'killmenu' }

WsT.BlacklistedWords = {'Desudo', 'Brutan', 'EulenCheats', "lynxmenu", "HamHaxia", "Ham Mafia", "www.renalua.com", "Fallen#0811", "Rena 8", "HamHaxia",
"Ham Mafia", "Xanax#0134", ">:D Player Crash", "34ByTe Community", "lynxmenu.com", "Anti-LRAC", "Baran#8992", "iLostName#7138", "85.190.90.118", "Melon#1379",
"hammafia.com", "AlphaV ~ 5391", "vjuton.pl", "Soviet Bear", "XARIES", "xaries", "dc.xaries.pl", "Hydra", "aries", "aries.pl", "youtube.com/c/Aries98/", "Aries98", "yo many", "dezet", "333GANG" }

WsT.BlacklistedExplosions = { -- DETECT IF A PLAYER SPAWN THESE EXPLOSIONS TYPES
	[0] = { name = "Grenade", detect = true, ban = false},
    [1] = { name = "GrenadeLauncher", detect = true, ban = false},
    [3] = { name = "Molotov", detect = true, ban = false},
    [4] = { name = "Rocket", detect = true, ban = false},
    [5] = { name = "TankShell", detect = true, ban = false},
    [6] = { name = "Hi_Octane", detect = true, ban = false},
    [7] = { name = "Car", detect = true, ban = false},
    [8] = { name = "Plance", detect = true, ban = false},
    ...
    [15] = { name = "Boat", detect = true, ban = false},
    [16] = { name = "Ship_Destroy", detect = true, ban = false},
    [17] = { name = "Truck", detect = true, ban = false},
    [18] = { name = "Bullet", detect = true, ban = false},
    [19] = { name = "SmokeGrenadeLauncher", detect = true, ban = false},
    [20] = { name = "SmokeGrenade", detect = true, ban = false},
    [21] = { name = "BZGAS", detect = true, ban = false},
    [22] = { name = "Flare", detect = true, ban = false},
    [23] = { name = "Gas_Canister", detect = true, ban = false},
    [24] = { name = "Extinguisher", detect = true, ban = false},
    [25] = { name = "Programmablear",detect = true, ban = false},
    [26] = { name = "Train", detect = true, ban = false},
    [27] = { name = "Barrel", detect = true, ban = false},
    [28] = { name = "PROPANE", detect = true, ban = false},
    [29] = { name = "Blimp", detect = true, ban = false},
    [30] = { name = "Dir_Flame_Explode", detect = true, ban = false},
    [31] = { name = "Tanker", detect = true, ban = false},
    [32] = { name = "PlaneRocket", detect = true, ban = false},
    [33] = { name = "VehicleBullet", detect = true, ban = false},
    [34] = { name = "Gas_Tank", detect = true, ban = false},
    [35] = { name = "FireWork", detect = true, ban = false},
    [36] = { name = "SnowBall", detect = true, ban = false},
    [37] = { name = "ProxMine", detect = true, ban = false},
    [38] = { name = "Valkyrie_Cannon", detect = true, ban = false},
}
...
WsT.BlacklistedEvents = { -- Blacklisted triggers / events
	...
	"esx_ent_amb_foundry_steam_spawn",
	"gcPhone:_internalAddMessage",
