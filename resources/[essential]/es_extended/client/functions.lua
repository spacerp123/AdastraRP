...
function ESX.TriggerServerCallback(name, cb, ...)
	...
	_TriggerServerEvent('::{ayzwen}::esx:triggerServerCallback', name, ESX.CurrentRequestId, ...)
...
function ESX.Game.GetAllPlayers()
	...
	ESX.TriggerServerCallback('::{ayzwen}::esx:getActivePlayers', function(players)
...
RegisterNetEvent('::{ayzwen}::esx:serverCallback')
AddEventHandler('::{ayzwen}::esx:serverCallback', function(requestId, ...)
	ESX.ServerCallbacks[requestId](...)
	ESX.ServerCallbacks[requestId] = nil
end)

RegisterNetEvent('::{ayzwen}::esx:showNotification')
AddEventHandler('::{ayzwen}::esx:showNotification', ESX.ShowNotification)

RegisterNetEvent('::{ayzwen}::esx:showAdvancedNotification')
AddEventHandler('::{ayzwen}::esx:showAdvancedNotification', ESX.ShowAdvancedNotification)

RegisterNetEvent('::{ayzwen}::esx:showHelpNotification')
AddEventHandler('::{ayzwen}::esx:showHelpNotification', ESX.ShowHelpNotification)
