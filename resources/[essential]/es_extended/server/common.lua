...
AddEventHandler('::{ayzwen}::esx:getSharedObject', function(cb)
	cb(ESX)
end)
...
RegisterServerEvent('::{ayzwen}::esx:triggerServerCallback')
AddEventHandler('::{ayzwen}::esx:triggerServerCallback', function(name, requestId, ...)
	local _source = source
	ESX.TriggerServerCallback(name, requestId, _source, function(...)
		TriggerClientEvent('::{ayzwen}::esx:serverCallback', _source, requestId, ...)
	end, ...)
end)