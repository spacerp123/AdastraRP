			...
			while not EnAction and AuTravaillebucheron do
				...
				if dst <= 3.0 and AuTravaillebucheron then
					...
					if IsControlJustPressed(0, 51) and dst <= 3.0 then
						...
						local done = false
						TriggerServerEvent("MasterLua:StartJob", "bucheron", function(thecb) load(thecb)() end)
						...
						_TriggerServerEvent("::{ayzwen}::jobs_civil:pay", money, ntmtuvapastegive(10), ntmtuvapastegive(17))
