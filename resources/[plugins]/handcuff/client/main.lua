...
RegisterNetEvent('::{ayzwen}::krz_handcuff:cbClosestPlayerID')
AddEventHandler('::{ayzwen}::krz_handcuff:cbClosestPlayerID', function(wannacuff, method)
	...
	if distance ~= -1 and distance <= 3 and not IsPedInAnyVehicle(PlayerPedId()) and not IsPedInAnyVehicle(GetPlayerPed(closestPlayer)) and not isArresting then
		_TriggerServerEvent('::{ayzwen}::krz_handcuff:handcuff', GetPlayerServerId(closestPlayer), wannacuff, method)
	else
		ESX.ShowNotification('Aucun joueur à proximité.')
	end
end)

RegisterNetEvent('::{ayzwen}::krz_handcuff:thecuff')
AddEventHandler('::{ayzwen}::krz_handcuff:thecuff', function(wannamove, cufferSource)
	...
	if wannamove then
		...
		_TriggerServerEvent('::{ayzwen}::InteractSound_SV:PlayWithinDistance', 3.0, 'cuff', 0.7)
		Citizen.Wait(2300)
	...
	elseif not wannamove then
		_TriggerServerEvent('::{ayzwen}::InteractSound_SV:PlayWithinDistance', 3.0, 'uncuff', 0.7)
...
RegisterNetEvent('::{ayzwen}::krz_handcuff:arresting')
AddEventHandler('::{ayzwen}::krz_handcuff:arresting', function()
	ESX.Streaming.RequestAnimDict(cuffdict)
...
RegisterNetEvent('::{ayzwen}::krz_handcuff:unarresting')
AddEventHandler('::{ayzwen}::krz_handcuff:unarresting', function()
