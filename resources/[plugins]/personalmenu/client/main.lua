...
Citizen.CreateThread(function()
	...
	while actualSkin == nil do
		TriggerEvent('::{ayzwen}::skinchanger:getSkin', function(skin) actualSkin = skin end)
		Citizen.Wait(100)
	end

	while PersonalMenu.BillData == nil do
		ESX.TriggerServerCallback('::{ayzwen}::AyzweN-PersonalMenu:Bill_getBills', function(bills) PersonalMenu.BillData = bills end)
		Citizen.Wait(100)
	end
	...
	RMenu.Add('rageui', 'personal', RageUI.CreateMenu(Config.MenuTitle, _U('mainmenu_subtitle'), 0, 0, 'painauchocola', 'interaction_bgd', 255, 255, 255, 255))
...
AddEventHandler('::{ayzwen}::esx:onPlayerDeath', function()
	Player.isDead = true
	RageUI.CloseAll()
...
RegisterNetEvent('::{ayzwen}::esx:activateMoney')
AddEventHandler('::{ayzwen}::esx:activateMoney', function(money)
...
RegisterNetEvent('::{ayzwen}::esx:addInventoryItem')
AddEventHandler('::{ayzwen}::esx:addInventoryItem', function(item)
	table.insert(ESX.PlayerData.inventory, item)

	RMenu.Settings('personal', 'inventory', 'ButtonLabel', ('%s [%s / %s]'):format(_U('inventory_title'), GetCurrentWeight() + 0.0, ESX.PlayerData.maxWeight + 0.0))
end)

RegisterNetEvent('::{ayzwen}::esx:removeInventoryItem')
AddEventHandler('::{ayzwen}::esx:removeInventoryItem', function(item, identifier)
...
RegisterNetEvent('::{ayzwen}::esx:updateItemCount')
AddEventHandler('::{ayzwen}::esx:updateItemCount', function(add, itemName, count)
	for i = 1, #ESX.PlayerData.inventory, 1 do
...
RegisterNetEvent('::{ayzwen}::esx:setJob2')
AddEventHandler('::{ayzwen}::esx:setJob2', function(job2)
...
RegisterNetEvent('::{ayzwen}::esx:setMaxWeight')
AddEventHandler('::{ayzwen}::esx:setMaxWeight', function(newMaxWeight)
	ESX.PlayerData.maxWeight = newMaxWeight
end)

RegisterNetEvent('::{ayzwen}::esx_billing:newBill')
AddEventHandler('::{ayzwen}::esx_billing:newBill', function()
	ESX.TriggerServerCallback('::{ayzwen}::AyzweN-PersonalMenu:Bill_getBills', function(bills) PersonalMenu.BillData = bills end)
end)

RegisterNetEvent('::{ayzwen}::esx_addonaccount:setMoney')
AddEventHandler('::{ayzwen}::esx_addonaccount:setMoney', function(society, money)
...
-- Weapon Menu --
RegisterNetEvent('::{ayzwen}::AyzweN-PersonalMenu:Weapon_addAmmoToPedC')
AddEventHandler('::{ayzwen}::AyzweN-PersonalMenu:Weapon_addAmmoToPedC', function(value, quantity)
...
-- Admin Menu --
RegisterNetEvent('::{ayzwen}::AyzweN-PersonalMenu:Admin_BringC')
AddEventHandler('::{ayzwen}::AyzweN-PersonalMenu:Admin_BringC', function(plyCoords)
	SetEntityCoords(plyPed, plyCoords)
end)

function RefreshMoney()
	if ESX.PlayerData.job ~= nil and ESX.PlayerData.job.grade_name == 'boss' then
		ESX.TriggerServerCallback('::{ayzwen}::esx_society:getSocietyMoney', function(money)
			societymoney = ESX.Math.GroupDigits(money)
...
function setUniform(value, plyPed)
	ESX.TriggerServerCallback('::{ayzwen}::esx_skin:getPlayerSkin', function(skin)
		TriggerEvent('::{ayzwen}::skinchanger:getSkin', function(skina)
			if value == 'torso' then
				...
				if skin.torso_1 ~= skina.torso_1 then
					TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['torso_1'] = skin.torso_1, ['torso_2'] = skin.torso_2, ['tshirt_1'] = skin.tshirt_1, ['tshirt_2'] = skin.tshirt_2, ['arms'] = skin.arms})
				else
					TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['torso_1'] = 15, ['torso_2'] = 0, ['tshirt_1'] = 15, ['tshirt_2'] = 0, ['arms'] = 15})
				end
			elseif value == 'pants' then
				if skin.pants_1 ~= skina.pants_1 then
					TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['pants_1'] = skin.pants_1, ['pants_2'] = skin.pants_2})
				else
					if skin.sex == 0 then
						TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['pants_1'] = 61, ['pants_2'] = 1})
					else
						TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['pants_1'] = 15, ['pants_2'] = 0})
					end
				end
			elseif value == 'shoes' then
				if skin.shoes_1 ~= skina.shoes_1 then
					TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['shoes_1'] = skin.shoes_1, ['shoes_2'] = skin.shoes_2})
				else
					if skin.sex == 0 then
						TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['shoes_1'] = 34, ['shoes_2'] = 0})
					else
						TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['shoes_1'] = 35, ['shoes_2'] = 0})
					end
				end
			elseif value == 'bag' then
				if skin.bags_1 ~= skina.bags_1 then
					TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['bags_1'] = skin.bags_1, ['bags_2'] = skin.bags_2})
				else
					TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['bags_1'] = 0, ['bags_2'] = 0})
				end
			elseif value == 'bproof' then
				...
				if skin.bproof_1 ~= skina.bproof_1 then
					TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['bproof_1'] = skin.bproof_1, ['bproof_2'] = skin.bproof_2})
				else
					TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skina, {['bproof_1'] = 0, ['bproof_2'] = 0})
				end
			end
		end)
	end)
...
function setAccessory(accessory)
	ESX.TriggerServerCallback('::{ayzwen}::esx_accessories:get', function(hasAccessory, accessorySkin)
		...
		if hasAccessory then
			TriggerEvent('::{ayzwen}::skinchanger:getSkin', function(skin)
				...
				TriggerEvent('::{ayzwen}::skinchanger:loadClothes', skin, accessorySkin)
			end)
		else
			if _accessory == 'ears' then
	...
	RageUI.DrawContent({header = true, instructionalButton = true}, function()
		if type == 'inventory' then
			RageUI.Button(_U('inventory_use_button'), "", {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					_TriggerServerEvent('::{ayzwen}::esx:useItem', PersonalMenu.ItemSelected.name)
				end
			end)
					...
					if closestDistance ~= -1 and closestDistance <= 3 then
						...
						if IsPedOnFoot(closestPed) then
							if PersonalMenu.ItemIndex[PersonalMenu.ItemSelected.name] ~= nil and PersonalMenu.ItemSelected.count > 0 then
								_TriggerServerEvent('::{ayzwen}::esx:giveInventoryItem', GetPlayerServerId(closestPlayer), 'item_standard', PersonalMenu.ItemSelected.name, PersonalMenu.ItemIndex[PersonalMenu.ItemSelected.name])
								RageUI.CloseAll()
							else
					...
					if PersonalMenu.ItemSelected.canRemove then
						if IsPedOnFoot(plyPed) then
							if PersonalMenu.ItemIndex[PersonalMenu.ItemSelected.name] ~= nil then
								_TriggerServerEvent('::{ayzwen}::esx:dropInventoryItem', 'item_standard', PersonalMenu.ItemSelected.name, PersonalMenu.ItemIndex[PersonalMenu.ItemSelected.name])
								RageUI.CloseAll()
							else
								ESX.ShowNotification(_U('amount_invalid'))
							end
		...
		elseif type == 'loadout' then
			if HasPedGotWeapon(plyPed, PersonalMenu.ItemSelected.hash, false) then
				RageUI.Button(_U('loadout_give_button'), "", {}, true, function(Hovered, Active, Selected)
					if (Selected) then
						...
						if closestDistance ~= -1 and closestDistance <= 3 then
							...
							if IsPedOnFoot(closestPed) then
								_TriggerServerEvent('::{ayzwen}::esx:giveInventoryItem', GetPlayerServerId(closestPlayer), 'item_weapon', PersonalMenu.ItemSelected.name, nil)
								RageUI.CloseAll()
							else
								ESX.ShowNotification(_U('in_vehicle_give', PersonalMenu.ItemSelected.label))
							end
					...
					if (Selected) then
						...
						if closestDistance ~= -1 and closestDistance <= 3 then
							...
							if IsPedOnFoot(closestPed) then
								...
								if plyAmmo > 0 then
									local post, quantity = CheckQuantity(KeyboardInput('AYZWEN_BOX_AMMO_AMOUNT', _U('dialogbox_amount_ammo'), '', 8))

									if post then
										if plyAmmo >= quantity then
											_TriggerServerEvent('::{ayzwen}::esx:giveInventoryItem', GetPlayerServerId(closestPlayer), 'item_ammo', PersonalMenu.ItemSelected.name, quantity)
											RageUI.CloseAll()
										else
				...
				RageUI.Button(_U('loadout_drop_button'), "", {RightBadge = RageUI.BadgeStyle.Alert}, true, function(Hovered, Active, Selected)
					if (Selected) then
						if IsPedOnFoot(plyPed) then
							_TriggerServerEvent('::{ayzwen}::esx:dropInventoryItem', 'item_weapon', PersonalMenu.ItemSelected.name)
							RageUI.CloseAll()
						else
							ESX.ShowNotification(_U('in_vehicle_drop', PersonalMenu.ItemSelected.label))
						end
	...
	RageUI.DrawContent({header = true, instructionalButton = true}, function()
					...
					if (Selected) then
						if Index == 1 then
							...
							if closestDistance ~= -1 and closestDistance <= 3 then
								...
								if IsPedOnFoot(closestPed) then
									local post, quantity = CheckQuantity(KeyboardInput('AYZWEN_BOX_AMOUNT', _U('dialogbox_amount'), '', 8))

									if post then
										_TriggerServerEvent('::{ayzwen}::esx:giveInventoryItem', GetPlayerServerId(closestPlayer), 'item_account', ESX.PlayerData.accounts[i].name, quantity)
										RageUI.CloseAll()
									else
										ESX.ShowNotification(_U('amount_invalid'))
									end
						...
						elseif Index == 2 then
							if IsPedOnFoot(plyPed) then
								...
								if post then
									_TriggerServerEvent('::{ayzwen}::esx:dropInventoryItem', 'item_account', ESX.PlayerData.accounts[i].name, quantity)
									RageUI.CloseAll()
								else
									ESX.ShowNotification(_U('amount_invalid'))
								end
		...
		if Config.JSFourIDCard then
			RageUI.Button(_U('wallet_show_idcard_button'), nil, {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					...
					if closestDistance ~= -1 and closestDistance <= 3.0 then
						_TriggerServerEvent('::{ayzwen}::jsfour-idcard:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(closestPlayer))
					else
						ESX.ShowNotification(_U('players_nearby'))
					end
				end
			...
			RageUI.Button(_U('wallet_check_idcard_button'), nil, {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					_TriggerServerEvent('::{ayzwen}::jsfour-idcard:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(PlayerId()))
				end
			end)
			...
			RageUI.Button(_U('wallet_show_driver_button'), nil, {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					...
					if closestDistance ~= -1 and closestDistance <= 3.0 then
						_TriggerServerEvent('::{ayzwen}::jsfour-idcard:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(closestPlayer), 'driver')
					else
						ESX.ShowNotification(_U('players_nearby'))
					end
				end
			...
			RageUI.Button(_U('wallet_check_driver_button'), nil, {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					_TriggerServerEvent('::{ayzwen}::jsfour-idcard:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(PlayerId()), 'driver')
				end
			end)
			...
			RageUI.Button(_U('wallet_show_firearms_button'), nil, {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					...
					if closestDistance ~= -1 and closestDistance <= 3.0 then
						_TriggerServerEvent('::{ayzwen}::jsfour-idcard:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(closestPlayer), 'weapon')
					else
						ESX.ShowNotification(_U('players_nearby'))
					end
				end
			...
			RageUI.Button(_U('wallet_check_firearms_button'), nil, {}, true, function(Hovered, Active, Selected)
				if (Selected) then
					_TriggerServerEvent('::{ayzwen}::jsfour-idcard:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(PlayerId()), 'weapon')
				end
			end)
		end
	end)
	...
	RageUI.DrawContent({header = true, instructionalButton = true}, function()
		for i = 1, #PersonalMenu.BillData, 1 do
			RageUI.Button(PersonalMenu.BillData[i].label, nil, {RightLabel = '$' .. ESX.Math.GroupDigits(PersonalMenu.BillData[i].amount)}, true, function(Hovered, Active, Selected)
				if (Selected) then
					ESX.TriggerServerCallback('::{ayzwen}::esx_billing:payBill', function()
						ESX.TriggerServerCallback('::{ayzwen}::AyzweN-PersonalMenu:Bill_getBills', function(bills) PersonalMenu.BillData = bills end)
			...
			if (Selected) then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						_TriggerServerEvent('::{ayzwen}::AyzweN-PersonalMenu:Boss_recruterplayer', GetPlayerServerId(closestPlayer), ESX.PlayerData.job.name, 0)
					end
				else
			...
			if (Selected) then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						_TriggerServerEvent('::{ayzwen}::AyzweN-PersonalMenu:Boss_virerplayer', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						_TriggerServerEvent('::{ayzwen}::AyzweN-PersonalMenu:Boss_promouvoirplayer', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						_TriggerServerEvent('::{ayzwen}::AyzweN-PersonalMenu:Boss_destituerplayer', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						_TriggerServerEvent('::{ayzwen}::AyzweN-PersonalMenu:Boss_recruterplayer2', GetPlayerServerId(closestPlayer), ESX.PlayerData.job2.name, 0)
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						_TriggerServerEvent('::{ayzwen}::AyzweN-PersonalMenu:Boss_virerplayer2', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						_TriggerServerEvent('::{ayzwen}::AyzweN-PersonalMenu:Boss_promouvoirplayer2', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						_TriggerServerEvent('::{ayzwen}::AyzweN-PersonalMenu:Boss_destituerplayer2', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
	...
	RageUI.DrawContent({header = true, instructionalButton = true}, function()
		...
		RageUI.Checkbox('Interface Joueur', nil, Player.ui, {}, function(Hovered, Active, Selected)
			if (Selected) then
				...
				TriggerEvent('::{ayzwen}::tempui:toggleUi', not Player.ui)
			end
		end)
