...
RegisterServerEvent('::{ayzwen}::GangsBuilder:confiscatePlayerItem')
AddEventHandler('::{ayzwen}::GangsBuilder:confiscatePlayerItem', function(target, itemType, itemName, amount)
...
RegisterServerEvent('::{ayzwen}::GangsBuilder:putInVehicle')
AddEventHandler('::{ayzwen}::GangsBuilder:putInVehicle', function(target)
	...
	if xPlayerTarget ~= nil then
		...
		if cuffState.isCuffed then
			TriggerClientEvent('::{ayzwen}::GangsBuilder:putInVehicle', target)
		end
	end
end)

RegisterServerEvent('::{ayzwen}::GangsBuilder:OutVehicle')
AddEventHandler('::{ayzwen}::GangsBuilder:OutVehicle', function(target)
	local xPlayerTarget = ESX.GetPlayerFromId(target)
	...
	if xPlayerTarget ~= nil then
		...
		if cuffState.isCuffed then
			TriggerClientEvent('::{ayzwen}::GangsBuilder:OutVehicle', target)
		end
	end
end)

RegisterServerEvent('::{ayzwen}::GangsBuilder:getStockItem')
AddEventHandler('::{ayzwen}::GangsBuilder:getStockItem', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)

	TriggerEvent('::{ayzwen}::esx_addoninventory:getSharedInventory', 'society_' .. xPlayer.job2.name, function(inventory)
...
ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:getStockItems', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('::{ayzwen}::GangsBuilder:putStockItems')
AddEventHandler('::{ayzwen}::GangsBuilder:putStockItems', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:getPlayerInventory', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	cb({items = xPlayer.inventory})
end)

ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:getOtherPlayerData', function(source, cb, target)
...
ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:getVehicleInfos', function(source, cb, plate)
...
ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:getArmoryWeapons', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)

	TriggerEvent('::{ayzwen}::esx_datastore:getSharedDataStore', 'society_' .. xPlayer.job2.name, function(store)
		local weapons = store.get('weapons') or {}
		cb(weapons)
	end)
end)

ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:addArmoryWeapon', function(source, cb, weaponName, weaponAmmo)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:removeArmoryWeapon', function(source, cb, weaponName, weaponAmmo)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:buyWeapon', function(source, cb, weaponName)
	local xPlayer = ESX.GetPlayerFromId(source)
	...
	TriggerEvent('::{ayzwen}::esx_addonaccount:getSharedAccount', 'society_' .. xPlayer.job2.name, function(account)
...
ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:isBusy', function(source, cb, type, identifier)
...
ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:AddBusyList', function(source, cb, type, identifier)
	if BusyList[type].serverId then
		identifier = source
	end
...
ESX.RegisterServerCallback('::{ayzwen}::GangsBuilder:RemoveBusyList', function(source, cb, type, identifier)
	if BusyList[type].serverId then
		identifier = source
	end
