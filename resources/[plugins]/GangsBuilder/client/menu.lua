...
function DrawGangMenu()
	...
	addGangMenu.SubMenu.OnItemSelect = function(_, item, index)
		...
		if item == confirmItem then
			...
			_TriggerServerEvent('::{ayzwen}::GangsBuilder:addGang', GangData)
		end
	end
...
RegisterNetEvent('::{ayzwen}::GangsBuilder:OpenMenu')
AddEventHandler('::{ayzwen}::GangsBuilder:OpenMenu', function()
