...
function UIMenuListItem.New(Text, Items, Index, Description)
    ...
    local _UIMenuListItem = {
        Base = UIMenuItem.New(Text or "", Description or ""),
        Items = Items,
        LeftArrow = Sprite.New("painauchocola", "arrowleft", 110, 105, 30, 30),
        RightArrow = Sprite.New("painauchocola", "arrowright", 280, 105, 30, 30),
...
function UIMenuSliderItem.New(Text, Items, Index, Description, Divider)
    ...
    local _UIMenuSliderItem = {
        ...
        LeftArrow = Sprite.New("painauchocolatu", "arrowleft", 0, 105, 15, 15),
        RightArrow = Sprite.New("painauchocolatu", "arrowright", 0, 105, 15, 15),
...
function UIMenuColourPanel.New(Title, Colours)
    _UIMenuColourPanel = {
        ...
        Background = Sprite.New("painauchocola", "gradient_bgd", 0, 0, 431, 112),
        Bar = {},
        LeftArrow = Sprite.New("painauchocola", "arrowleft", 0, 0, 30, 30),
        RightArrow = Sprite.New("painauchocola", "arrowright", 0, 0, 30, 30),
...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName)
    ...
    if TxtDictionary ~= nil then TxtDictionary = tostring(TxtDictionary) or "painauchocola" else TxtDictionary = "painauchocola" end
    ...
    _UIMenu.ArrowSprite = Sprite.New("painauchocola", "shop_arrows_upanddown", 190 + _UIMenu.Position.X, 147 + 37 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 50, 50)
