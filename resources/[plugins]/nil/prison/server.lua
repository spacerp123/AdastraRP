...
end, {help = "Mettre en prison les gens pas tres gentils", params = { {name = "id", help = "L'ID du joueur"}, {name = "secondes", help = "Temps de prison"} }})
...
end, {help = "Liberer quelqun de prison", params = { {name = "id", help = "L'ID du joueur"} }})
