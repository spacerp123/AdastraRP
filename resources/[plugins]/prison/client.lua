...
Citizen.CreateThread(function()
  while true do
    ...
    if jailTimeG > 0 then
      ...
      SetTextEntry("STRING")
      if isJailedG then
        AddTextComponentString("Temps De Prison Restant: " .. tostring(jailTimeG) .. " Secondes")
      else
        AddTextComponentString("Temps De Prison Restant: " .. tostring(jailTimeG) .. " Secondes - PAUSE")
      end
      DrawText(0.5, 0.005)
    end
  end
